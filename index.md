...
Hi, I’m Amadou Diallo — a Junior at Lehigh University pursuing a B.S. in Business and Economics with majors in Finance and Accounting.

I’m passionate about learning new things and balancing my work life and personal life. I’m actively involved in the African Student Association and the Lehigh Car Club on campus. I currently have an upcoming accounting internship where I will assist with various projects and contribute to the goals of the team.

Outside the classroom, I enjoy bowling, playing spikeball, and going out for a drive. I’m constantly exploring ways to grow both professionally and personally.

This site is where I share updates on my projects, resume, and things I’m learning.
...
### Introduction
In this report, I will be performing sentiment analysis on SEC 10-K filings. The project uses custom word lists and near-sentence matching algorithms to extract text from SEC filings and quantify sentiment across several categories (regulatory, uncertainty, operational, competition, and macroeconomic). This analysis is intended to help researchers and practitioners better understand how different sentiment dimensions in 10-K reports correlate with various business outcomes.
...
Below is my output from my regression analysis on the housing dataset:
